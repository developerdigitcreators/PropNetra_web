...
export default function ResalePage() {
    ...
    const banners = [
        { title: "Resale Opportunities", img: "https://images.unsplash.com/photo-1545324418-cc1a3fa10c00?q=80&w=2000" },
        { title: "Premium Resale", img: "https://images.unsplash.com/photo-1600585154340-be6161a56a0c?q=80&w=2000" }
    ];
                    ...
                    {banners.map((banner, idx) => (
                        <div key={idx} className="min-w-full h-full relative">
                            ...
                            <div className={`absolute inset-0 flex flex-col justify-center items-start text-left p-12 md:p-24 transition-all duration-1000 ${idx === currentBanner ? 'opacity-100 translate-y-0 scale-100' : 'opacity-0 translate-y-20 scale-95 pointer-events-none'}`}>
                                ...
                                <p className="agent-small text-white/50 font-light max-w-2xl mb-10 uppercase tracking-[0.2em] border-l-2 border-white/20 pl-6">Premium Resale Market</p>
                            </div>
                        </div>
                    ))}
                </div>
